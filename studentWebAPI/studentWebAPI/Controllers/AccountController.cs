...
namespace studentWebAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserToken>> CreateUser([FromBody] RegisterModel model)
        {
            ...
            {
                ModelState.AddModelError("ConfirmPassword", "The passwords no match");
            ...
            if (result)
            {
                return Ok($"User {model.Email} sucess created");
            }
            else
            {
                ModelState.AddModelError("CreateUser", "Invalid register, use password with numbers, characters and upper/lower case letters");
                return BadRequest(ModelState);
            }
        }
